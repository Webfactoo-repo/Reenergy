...
vc_map( array (
  ...
  'base' => 'latest_blog_effect',

  'name' => 'Latest From Blog Creative',
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'heading' => 'Select first testimonial:',
...
vc_map( array (
  ...
  'base' => 'simple_testimonial',

  'name' => 'Simple Testimonial (Circular)',
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'description' => 'The code you will find on the end url after mid',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'With border at top' => 'border_top',

        'With border at left side' => 'border_left',
    ...
    array (
      ...
      'description' => 'Light version is with white text color and white button color. Use this on sections',
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'description' => 'Leave \'base\' to use the default skin color',
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'heading' => 'Do you want a predefined Icon?',
...
vc_map( array (
  ...
  'base' => 'services_medium_box',

  'name' => 'Services Medium Box',
  ...
  array (
    ...
    array (
      ...
      'heading' => 'Select the position of the icon wrapper',
...
vc_map( array(
  ...
  "name"  => __("Creative Tabs Container", "js_composer"),

  "base" => "creative_tabs",

  "as_parent" => array('only' => 'creative_tab'),

  "show_settings_on_create" => false,

  "is_container" => true,

  "category" => __('Themeple Elements', 'js_composer'),
...
vc_map( array(
  ...
  "name" => __("Creative Tab", "js_composer"),

  "base" => "creative_tab",

  'as_child' => array('only' => 'creative_tabs'),
  ...
  "params" => array(
    ...
    array(
            ...
            "description" => 'Use 1 for the first tab to make it active.',
    ...
    array(    
      ...
      "heading"    => "Icon or Number ?",

      "param_name"      => "icon_number",

      "value"     => array("Number" => 'number', 'Icon' => 'icon'),
    ...
    array(    
      ...
      "dependency" => array("element" => 'icon_number', 'value' => 'icon')
    ...
    array(    
      ...
      "dependency" => array("element" => 'icon_number', 'value' => 'number')
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'heading' => 'Do you want Icon or Text ?',
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'description' => 'Leave "base" to use the selected base color in theme options',
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'heading' => 'Small Title Font Size (px)',

      'admin_label' => true,

      'param_name' => 'size_small_title',
    ...
    array (
      ...
      'heading' => 'Second Title Font Size (px)',

      'admin_label' => true,

      'param_name' => 'size_second_title',
...
vc_map( array (
  ...
  array (
    ...
    array (
      ...
      'description' => 'If you want to use the default theme color write "base" instead of color code',
...
vc_add_param("vc_row", array(
  ...
  "heading" => "Add a link for a one page menu",
...
vc_add_param("vc_row", array(
  ...
  "value" => array("Check to remove section borders" => true ),

  "param_name" => "no_borders",

  "description" => "Check this if you want to remove the borders top and bottom of this section"
...
class WPBakeryShortCode_Latest_Blog_Effect extends WPBakeryShortCode {
...
class WPBakeryShortCode_Services_New extends WPBakeryShortCode {
...
class WPBakeryShortCode_Services_Medium_Box extends WPBakeryShortCode {
...
class WPBakeryShortCode_Creative_Tabs extends WPBakeryShortCodesContainer {
...
class WPBakeryShortCode_Creative_Tab extends WPBakeryShortCode {
...
class WPBakeryShortcode_Fullwidth_Portfolio extends WPBakeryShortCode{
