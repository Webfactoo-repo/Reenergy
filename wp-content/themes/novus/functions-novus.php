...
if(!function_exists('themeple_frontend_js'))
{
	...
	{	wp_register_script( 'jquery-easing-1-1', THEMEPLE_BASE_URL.'js/jquery.easing.1.1.js', array('jquery'), 1, true );
        ...
        wp_register_script('jquery.nicescroll.min', THEMEPLE_BASE_URL. 'js/jquery.nicescroll.min.js', array('jquery', 'jquery.themepunch.plugins.min'), 1, false);       
...
function my_theme_register_required_plugins() {
  ...
  $plugins = array(
    ...
    array(
      ...
      'source'          => get_stylesheet_directory() . '/plugins/layersliderwp-5.0.2.installable.zip', // The plugin source
