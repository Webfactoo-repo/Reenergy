...
if(!function_exists('themeple_get_option')){
    ...
    function themeple_get_option($key = false, $default = "", $echo = false, $decode = true){
		...
		if(isset($_COOKIE['themeple_shadow']) && $_COOKIE['themeple_shadow'] != '' && $key == 'header_shadow')
			$result = $_COOKIE['themeple_shadow'];
		...
		if(isset($_COOKIE['themeple_footer_skin']) && $_COOKIE['themeple_footer_skin'] != '' && $key == 'footer_skin')
			$result = $_COOKIE['themeple_footer_skin'];
		if($echo) echo $result;
	...
	function themeple_logo($default = "")
	{
		if($logo = themeple_get_option('logo'))
		{
			 if(isset($_COOKIE['themeple_skin']) && $_COOKIE['themeple_skin'] != ''){
			 	$logo = THEMEPLE_BASE_URL.'img/skins/'.$_COOKIE['themeple_skin'].'/logo.png';
			 }
