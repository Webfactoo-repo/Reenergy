...
class FooterLogoDesc extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        $logo = themeple_get_option('footer_logo');

        if(!empty($logo)){
 
          $footerlogodesc.='<div class="footerlogodesc_logo"><img src="'.$logo.'" /></div>';
        }
    ...
    function form($instance){
        ...
        <p>
            ...
            <textarea id="<?php echo $this->get_field_id('content'); ?>" name="<?php echo $this->get_field_name('content'); ?>"> <?php echo esc_attr($content); ?> </textarea></label>
...
class RecentContentWidget extends WP_Widget{
    ...
    function RecentContentWidget(){
        ...
        $options = array('classname' => 'widget_recent_content', 'description' => 'Add a widget to display recent posts' );
                            ...
                            <div id="recent">
						        ...
						        while (have_posts()) : the_post();
						            ...
						            <dl>
                                      ...
                                      <dt>
                                      <?php the_post_thumbnail('blog_recent'); ?>
                                      </dt>
    ...
    function form($instance){
        ...
        <p>
         ...
         <p>
            ...
            <label for="<?php echo $this->get_field_id('email'); ?>">Emai:l 
...
class ContactInfoWidget extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        echo '<ul>';
            ...
            if(!empty($email))
                echo '<li class="email"><span>'.$email.'</span></li>';
        	if(!empty($address))
        		echo '<li class="address"><span>'.$address.'</span></li>';
        	if(!empty($phone))
        		echo '<li class="phone"><span>'.$phone.'</span></li>';
        	if(!empty($fax))
        		echo '<li class="fax"><span>'.$fax.'</span></li>';
