                                       ...
                                       <div class="overlay he-view">
                                            <div class="bg a0" data-animate="fadeIn">
                                                <div class="center-bar v1">
                                                    ...
                                                    <h3 class="a1" data-animate="fadeInUp"><?php echo get_the_title() ?></h3>
                                                    <span class="cat a2" data-animate="fadeInUp"><?php echo $sort_classes ?></span>
                         ...
                         <?php } ?>
                                       <div class="overlay he-view">
                                        ...
                                        <div class="show_text">
                                            ...
                                            <p><?php echo themeple_text_limit(get_the_excerpt(), 12) ?></p>
                                        </div>     
...
if( ((isset($themeple_config['used_for_element']) && !$themeple_config['used_for_element']) || !isset($themeple_config['used_for_element']) ) && $portfolio_p =+ '' ){
?>
