...
if(!function_exists('themeple_sc_button')){
    ...
    function themeple_sc_button($atts, $content=null, $shortcodename =""){
        ...
        extract(shortcode_atts(array('icon' => '', 'type' => '', 'link' => '', 'onclick' => '', 'color' => '', 'size' => '', 'icon_color' => '', 'fontcolor'=> '', 'border_color'=>'', 'target'=>''), $atts));
        ...
        if($type == 'only_border'){
            ...
            $output .= '<a target="'.$target.'" href="'.$link.'" class="btn-system '.$size.' '.$type.'" style="border:1px solid '.$border_color.'">';
        ...
        if($type == 'anchor'){
            ...
            $output .= '<a target="'.$target.'" href="'.$link.'" class="btn-system '.$size.'" style="'.$background.';'.$border.'">';
    ...
    function themeple_sc_price_1($atts, $content = null, $shortcodename=""){
      ...
      if($footer_bool == 'yes'){
        ...
        $output .= '<div class="footer">';
            ...
            $output .= '<a href="'.$footer_link.'" class="btn-system">'.$footer_button_text.'</a>';
...
if(!function_exists('themeple_sc_highlights')){
    ...
    function themeple_sc_highlights($atts, $content = null, $shortcodename=""){
	  ...
	  if(isset($_COOKIE['themeple_skin'])){
       ...
       if($fcolor_bool == 'yes'){
           $output =  '<span class="highlights" style="color: '.$base_color.'; font-weight:500; font-size:inherit;">'.do_shortcode($content).'</span>';       
            ...
            $output =  '<span style="color: '.$font_color.'; background:'.$base_color.'; font-weight:500; font-size:inherit;">'.do_shortcode($content).'</span>';       
