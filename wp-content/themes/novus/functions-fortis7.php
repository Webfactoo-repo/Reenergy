...
if(!function_exists('themeple_frontend_js'))
{
	...
	{	wp_register_script( 'jquery-easing-1-1', THEMEPLE_BASE_URL.'js/jquery.easing.1.1.js', array('jquery'), 1, true );
        ...
        wp_register_script('jquery.appear', THEMEPLE_BASE_URL.'js/jquery.appear-1.1.1.modified.js', array('jquery'), 1, false );
        ...
        wp_register_script('animations', THEMEPLE_BASE_URL.'js/animations.js', array('jquery', 'modernizr', 'jquery.appear', 'jquery.easy-pie-chart', 'jquery.countTo'), 1, false );
        wp_register_script('jquery.themepunch.plugins.min', THEMEPLE_BASE_URL.'js/megafolio/jquery.themepunch.plugins.min.js', array('jquery'), 1, false );
        wp_register_script('jquery.themepunch.megafoliopro', THEMEPLE_BASE_URL.'js/megafolio/jquery.themepunch.megafoliopro.js', array('jquery', 'jquery.themepunch.plugins.min'), 1, false );
        wp_register_script('jquery.themepunch.showbizpro.min', THEMEPLE_BASE_URL.'js/showbiz/jquery.themepunch.showbizpro.min.js', array('jquery', 'jquery.themepunch.plugins.min'), 1, false );
        

        wp_register_script('jquery.roundabout2', THEMEPLE_BASE_URL.'js/active_slider/jquery.roundabout2.js', array('jquery'), 1, false );
        wp_register_script('jquery.sliderTabs', THEMEPLE_BASE_URL.'js/jquery.sliderTabs.js', array('jquery'), 1, false );

        wp_register_script('kwicks_js', THEMEPLE_BASE_URL.'js/kwicks/kwicks.js', array('jquery'), 1, false );

        wp_register_script('waypoints.min', THEMEPLE_BASE_URL.'js/waypoints.min.js', array('jquery'), 1, false );
        wp_register_script('countdown', THEMEPLE_BASE_URL.'js/jquery.countdown.min.js', array('jquery'), 1, false );
        ...
        wp_register_style( 'showbiz',THEMEPLE_BASE_URL.'css/showbiz.css' );
        wp_register_style( 'jquery.sliderTabscss',THEMEPLE_BASE_URL.'css/jquery.sliderTabs.css' );       
        wp_register_style( 'kwicks_css',THEMEPLE_BASE_URL.'css/kwicks.css' );  
        
        wp_register_script('idangerous.swiper-2.0', THEMEPLE_BASE_URL.'js/idangerous.swiper-2.0.min.js', array('jquery'), 1, false );
...
function my_theme_register_required_plugins() {
  ...
  $plugins = array(
    ...
    array(
      ...
      'source'          => get_stylesheet_directory() . '/plugins/layersliderwp-5.0.2.installable', // The plugin source
